# Newport CONEX-AGAP 2.0 instrument driver
# David Christle <christle@uchicago.edu>, August 2014
#
#
# This drive controls the Newport CONEX-AGAP absolute positioners.
...
ndrv = ctypes.windll.LoadLibrary('C:\Program Files\Newport\Piezo Motion Control\Newport CONEX-AGAP Applet\Bin\ConexAGAPCmdLib.dll')


class Newport_CONEX_AGAP(Instrument):
